...
description: "Hands-on exploration of MCP using Docker Desktop's MCP Toolkit and Claude Desktop — setting it up and testing it against Obsidian, GitHub, web scraping, YouTube, LinkedIn, and PostgreSQL MCP servers."
pubDate: 2025-11-13
